...
const useProductListRow1ResponsiveSize = () => {
  ...
  React.useEffect(() => {
    ...
    const ScreenTabletSize = window.matchMedia(
      '(min-width: 573px) and (max-width: 1090px)'
    );
    ...
    const ScreenDesktopSize = window.matchMedia('(min-width: 1091px)');
...
export default useProductListRow1ResponsiveSize;
